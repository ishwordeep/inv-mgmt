        ...
        <table class="table" id="repeaterTable" style="min-width: 1000px;">
            ...
            <tbody id="stock-table">
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            <input type="date" class="form-control p-1 ExpiryDate" data-cntr='1' id="ExpiryDate-1" placeholder="Expiry Date" name="expiry_date[1]" size="1" style="width:7rem;" >
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" class="form-control p-1 UnitSale" data-cntr='1' id="UnitSale-1" placeholder="Unit Sales" name="unit_sale[1]" size="1" style="width:5rem;" >
                        </div>
                    </td>
                    @endif
                    <td>
                ...
                <table class="table table-sm table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="total_disc_amt" type="number" name="total_discount" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <th class="bg-primary text-white">Taxable Amount</th>
                            <td>
                                <input id="taxableAmt" type="number" name="taxable_amount" class="form-control">
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="totalTaxAmt" type="number" name="total_tax" class="form-control">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="net_amt" type="number" name="net_amount" class="form-control bg-secondary">
                            </td>
                        </tr>
                    </tbody>
                </table>
