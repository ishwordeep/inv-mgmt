            ...
            <div class="row m-3">
                ...
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" id="expectedDateAD" name='expected_delivery' value="{{ $entry->expected_delivery }}" class="form-control" placeholder="Entry Date" style="min-width: 100px;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row m-3">
                <div class="col-md-6 col-sm-12">
                    <div class="input-group mb-3">
                        ...
                        <textarea value="{{ $entry['comments'] }}" class="form-control comment" name="comments" placeholder="Remarks" rows="5"></textarea>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <table class="table table-sm table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input value="{{ $entry['gross_amt'] }}" id="gross_amt" type="numner" name="gross_amt" class="form-control" readonly>
                                </td>
                            </tr>
                            <tr>
                                <th class="bg-primary text-white">Total Discount</th>
                                <td>
                                    <input value="{{ $entry['discount_amt'] }}" id="total_disc_amt" type="number" name="discount_amt" class="form-control" readonly>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input value="{{ $entry['net_amt'] }}" id="net_amt" type="number" name="net_amt" class="form-control bg-secondary" readonly>
                                </td>
                            </tr>
                        </tbody>
                    </table>
