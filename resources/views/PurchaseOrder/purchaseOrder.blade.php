        ...
        <table class="table" id="repeaterTable" style="min-width: 1000px;">
            ...
            <tbody id="po-table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" class="form-control p-1 AddQty" data-cntr='1' id="AddQty-1" placeholder="Add Qty" name="purchase_qty[1]" size="1" style="width:5rem;" disabled>
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                            <input type="number" class="form-control p-1 FreeQty" data-cntr='1' id="FreeQty-1" placeholder="Free Qty" name="free_qty[1]" size="1" style="width:5rem;"  disabled>
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" class="form-control p-1 UnitCost" data-cntr='1' id="UnitCost-1" placeholder="Unit Cost" name="purchase_price[1]" size="1" style="width:5rem;" disabled >
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" class="form-control p-1 Discount" data-cntr='1' id="Discount-1" placeholder="Discount" name="discount[1]" size="1" style="width:5rem;" disabled>
                        </div>
                    </td>
