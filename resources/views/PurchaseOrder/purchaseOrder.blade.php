        ...
        <div class="row m-3">
            ...
            <div class=" col-sm-4">
                <div class="input-group mb-3">
                    ...
                    <select class="form-select form-control" id="po_type" name="po_type_id" style="min-width: 150px;" required>
            ...
            <div class=" col-sm-4">
                <div class="input-group mb-3">
                    ...
                    <select class="form-select form-control" id="supplier" name="supplier_id" style="min-width: 100px;" required>
        ...
        <table class="table" id="repeaterTable" style="min-width: 1000px;">
            ...
            <tbody id="po-table">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" min="0" class="form-control p-1 AddQty" data-cntr='1' id="AddQty-1" placeholder="Add Qty" name="purchase_qty[1]" size="1" style="width:5rem;" disabled required>
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                ...
                <tr id="repeaterRowPO" class="d-none">
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" min="0" class="form-control p-1 AddQty" data-cntr='' id="" placeholder="Add Qty" name="" size="1" style="width:5rem;"disabled required>
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                ...
                <table class="table table-sm table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="total_disc_amt" type="number" min="0" name="discount_amt" class="form-control" readonly>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="net_amt" type="number" min="0" name="net_amt" class="form-control bg-secondary" readonly>
                            </td>
                        </tr>
                    </tbody>
                </table>
