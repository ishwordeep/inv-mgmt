        ...
        */
        ...
        language: {
          ...
          dom:
            ...
            "<'row'<'col-sm-12'tr>>" +
            "<'row mt-2 d-print-none '<'col-sm-12 col-md-4'l><'col-sm-0 col-md-4 _c-center'B><'col-sm-12 col-md-4 'p>>",
            drawCallback: function( settings ) {
                if($('.DTFC_RightWrapper').css('width') !== undefined){
                    setTimeout(function(){ 
                        $('.DTFC_RightWrapper').css('width', (parseFloat($('.DTFC_RightWrapper').css('width').replace('px','')) + 22) + "px");
                    }, 0);
                }
            }
        }
