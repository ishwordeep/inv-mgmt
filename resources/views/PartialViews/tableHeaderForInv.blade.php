...
<tr class="text-white" style="background-color: #192840">
    ...
    <th scope="col">Free Qty <span class="text-danger">*</span></th>
    <th scope="col">Total Qty</th>
    @if($invType==='addRepeaterToStockEntry')
    <th scope="col">Expiry Date </th>
    @endif
    <th scope="col">Unit Cost <span class="text-danger">*</span></th>
    <th scope="col">Disc Mode<span class="text-danger">*</span></th>
    <th scope="col">Discount <span class="text-danger">*</span></th>
    @if($invType==='addRepeaterToStockEntry')
