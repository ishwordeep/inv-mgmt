            ...
            <div class="row m-3">
                ...
                {{--<div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="invoice_number" name='invoice_number' value="" class="form-control" placeholder="Inv Num" style="min-width: 100px;">
                    </div>
                </div>--}}
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" id="transaction_date" name='transaction_date' value="" class="form-control" placeholder="Approved Date" style="min-width: 100px;" required>
                    </div>
                </div>
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="company_name" style="min-width: 100px;">Company Name<span class="text-danger">*</span></label>
                        <input type="text" id="company_name" name='company_name' value="" class="form-control" placeholder="Company Name" style="min-width: 100px;" required>
                    </div>
                </div>
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="pan_vat" style="min-width: 100px;">Pan/Vat Number<span class="text-danger">*</span></label>
                        <input type="text" id="pan_vat" name='pan_vat' value="" class="form-control" placeholder="Pan/Vat Number" style="min-width: 100px;" required>
                    </div>
                </div>
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="full_name" style="min-width: 100px;"> Full Name<span class="text-danger">*</span></label>
                        <input type="text" id="full_name" name='full_name' value="" class="form-control" placeholder=" Full Name" style="min-width: 100px;" required>
                    </div>
                </div>
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="address" style="min-width: 100px;">Address<span class="text-danger">*</span></label>
                        <input type="text" id="address" name='address' value="" class="form-control" placeholder="Address" style="min-width: 100px;" required>
                    </div>
                </div>
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        <label class="input-group-text" for="contact_number" style="min-width: 100px;">Contact Number<span class="text-danger">*</span></label>
                        <input type="text" id="contact_number" name='contact_number' value="" class="form-control" placeholder="Contact Number" style="min-width: 100px;" required>
                    </div>
                </div>
                ...
                <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" id="expectedDateAD" name='expected_delivery' value="" class="form-control" placeholder="Entry Date" style="min-width: 100px;" required>
                    </div>
                </div>
                {{-- <div class=" col-sm-4 ">
                    <div class="input-group mb-3">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-group">
                                ...
                                <input type="hidden" name="inv_item_hidden[1]" id="inv_item_hidden-1" class="inv_item_hidden">
                            </div>
                        </td>
                        {{-- <td>
                            <div class="input-group">
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" class="form-control p-1 AddQty" data-cntr='1' id="AddQty-1" placeholder="Add Qty" name="purchase_qty[1]" size="1" style="width:5rem;" required>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" class="form-control p-1 UnitCost" data-cntr='1' id="UnitCost-1" placeholder="Unit Cost" name="purchase_price[1]" size="1" style="width:5rem;" required>
                            </div>
                        </td>
