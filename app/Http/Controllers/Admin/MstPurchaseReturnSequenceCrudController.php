...
use App\Http\Requests\MstPurchaseReturnSequenceRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class MstPurchaseReturnSequenceCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class MstPurchaseReturnSequenceCrudController extends CrudController
{
    ...
    {
        CRUD::setValidation(MstPurchaseReturnSequenceRequest::class);

        CRUD::field('id');
        CRUD::field('code');
        CRUD::field('name');
        CRUD::field('sequence_code');
